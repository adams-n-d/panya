...
\begin{DoxyCompactList}\small\item\em \-P\-O\-S\-I\-X \hyperlink{classoption_1_1_parser_a6e0b5778d1cfbd6cd51240e74d01e138}{parse()} (gnu==false) with non-\/const argv. \end{DoxyCompactList}\item 
...
\hypertarget{classoption_1_1_parser_aeeafbf2892a5aca90b89803b2b1cb031}{const char $\ast$ \hyperlink{classoption_1_1_parser_aeeafbf2892a5aca90b89803b2b1cb031}{non\-Option} (int i)}\label{classoption_1_1_parser_aeeafbf2892a5aca90b89803b2b1cb031}
...
\begin{DoxyCompactItemize}
\item 
\hypertarget{classoption_1_1_parser_a7183dc3501d1c87153f9c0d41f869460}{struct {\bfseries \-Stats}}\label{classoption_1_1_parser_a7183dc3501d1c87153f9c0d41f869460}
...
\hypertarget{classoption_1_1_parser_aa747e9792c9c08ede32b6c323438db71}{\index{option\-::\-Parser@{option\-::\-Parser}!\-Parser@{\-Parser}}
\index{\-Parser@{\-Parser}!option::Parser@{option\-::\-Parser}}
\subsubsection[{\-Parser}]{\setlength{\rightskip}{0pt plus 5cm}{\bf option\-::\-Parser\-::\-Parser} (
...
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}\label{classoption_1_1_parser_aa747e9792c9c08ede32b6c323438db71}
...
\hypertarget{classoption_1_1_parser_a2caa149140067b4d13e4d7a104bb3090}{\index{option\-::\-Parser@{option\-::\-Parser}!error@{error}}
\index{error@{error}!option::Parser@{option\-::\-Parser}}
\subsubsection[{error}]{\setlength{\rightskip}{0pt plus 5cm}bool {\bf option\-::\-Parser\-::error} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}\label{classoption_1_1_parser_a2caa149140067b4d13e4d7a104bb3090}
...
\begin{DoxyCode}
 if (parser.error() || options[UNKNOWN])
   exit(1);
\end{DoxyCode}
 \hypertarget{classoption_1_1_parser_a2c11b050f4248d71758dda52c5f9154d}{\index{option\-::\-Parser@{option\-::\-Parser}!non\-Options@{non\-Options}}
\index{non\-Options@{non\-Options}!option::Parser@{option\-::\-Parser}}
\subsubsection[{non\-Options}]{\setlength{\rightskip}{0pt plus 5cm}const char$\ast$$\ast$ {\bf option\-::\-Parser\-::non\-Options} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}\label{classoption_1_1_parser_a2c11b050f4248d71758dda52c5f9154d}
...
\end{DoxyNote}
\hypertarget{classoption_1_1_parser_aa64a6a7c196993a1b20d48e8ddd12a34}{\index{option\-::\-Parser@{option\-::\-Parser}!non\-Options\-Count@{non\-Options\-Count}}
\index{non\-Options\-Count@{non\-Options\-Count}!option::Parser@{option\-::\-Parser}}
\subsubsection[{non\-Options\-Count}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf option\-::\-Parser\-::non\-Options\-Count} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}\label{classoption_1_1_parser_aa64a6a7c196993a1b20d48e8ddd12a34}
...
\begin{DoxyNote}{\-Note}
\-A \hyperlink{classoption_1_1_parser_a6e0b5778d1cfbd6cd51240e74d01e138}{parse()} that does not encounter non-\/option arguments will leave this value as well as \hyperlink{classoption_1_1_parser_a2c11b050f4248d71758dda52c5f9154d}{non\-Options()} undisturbed. \-This means you can feed the \hyperlink{classoption_1_1_parser}{\-Parser} a default argument vector that contains non-\/option arguments (e.\-g. a default filename). \-Then you feed it the actual arguments from the user. \-If the user has supplied at least one non-\/option argument, all of the non-\/option arguments from the default disappear and are replaced by the user's non-\/option arguments. \-However, if the user does not supply any non-\/option arguments the defaults will still be in effect. 
\end{DoxyNote}
\hypertarget{classoption_1_1_parser_aee62badd2a19a5b88cbc4a9b11813b82}{\index{option\-::\-Parser@{option\-::\-Parser}!options\-Count@{options\-Count}}
\index{options\-Count@{options\-Count}!option::Parser@{option\-::\-Parser}}
\subsubsection[{options\-Count}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf option\-::\-Parser\-::options\-Count} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}\label{classoption_1_1_parser_aee62badd2a19a5b88cbc4a9b11813b82}
...
\end{DoxyNote}
\hypertarget{classoption_1_1_parser_a6e0b5778d1cfbd6cd51240e74d01e138}{\index{option\-::\-Parser@{option\-::\-Parser}!parse@{parse}}
\index{parse@{parse}!option::Parser@{option\-::\-Parser}}
\subsubsection[{parse}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf option\-::\-Parser\-::parse} (
\begin{DoxyParamCaption}
\item[{bool}]{gnu, }
\item[{const {\bf \-Descriptor}}]{usage\mbox{[}$\,$\mbox{]}, }
\item[{int}]{argc, }
...
\item[{int}]{bufmax = {\ttfamily -\/1}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}\label{classoption_1_1_parser_a6e0b5778d1cfbd6cd51240e74d01e138}
